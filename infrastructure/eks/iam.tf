...
resource "aws_iam_policy" "policy_alb" {
  name        = "${var.resource_prefix}-eks-alb-policy"
...
resource "aws_iam_role_policy_attachment" "eks-node-elb-att" {
  role       = aws_iam_role.eks-node-iam.name
  policy_arn = aws_iam_policy.policy_alb.arn
}